...
parent_dir = 'C:\\Users\\ijurkovic\\Desktop\\Udemy - Algo Trading\\Trading'
...
round(len(tickers_all) /4,0)
tickers1 = tickers_all[0:1663]
tickers2 = tickers_all[1663:4989]
tickers3 = tickers_all[4989:]
...
runfour_cy, runfour_py, runfour_py2 = get_fin(tickers_nan)
...
financial_dir_cy_df.update(runfour_cy)




combined_financials_cy2 = pd.DataFrame(financial_dir_cy2)
combined_financials_py2 = pd.DataFrame(financial_dir_py2)
combined_financials_py22 = pd.DataFrame(financial_dir_py22)

cy_data2 = combined_financials_cy2.T
tickers_nan = cy_data[cy_data['Assets'].isnull()].index.tolist()
