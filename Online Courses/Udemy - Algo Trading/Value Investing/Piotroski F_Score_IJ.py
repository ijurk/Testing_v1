# -*- coding: utf-8 -*-
"""
Created on Sat Apr 18 13:09:26 2020
...
- positive return on assets in the current year (1 point) 
   ROA =  net income/avg assets (beg and end)
...
2. Leverage, Liquidity, Source of Funds Criteria
- lower ratio of long term debt in the current period, compared to the previous year (decrease leverage)
- higher current ratio this year compared to the previous year (more liqidity)
    current assets/ current liabilities
- no new shares were issued in the last year (lack of dilution) (1 point)


3. Operating Efficiency Criteria:
- a higher gross margin compard to the previous year
    gross margin = gross profit (revenue - COGS) / revenue
- a higher asset turnover ratio compared to the previous year (how efficently using assetsto generate revenue)
    asset turnover = revenue / avg assets ( beg and end)
